...
exports.listenTo = function(el, fn) {
  el.addEventListener ? el.addEventListener('change', fn, true) : el.attachEvent('onchange', fn);
};
...
exports.unlistenTo = function(el, fn) {
  el.removeEventListener ? el.removeEventListener('change', fn, true) : el.detachEvent('onchange', fn);
};